    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="article_content_textarea" name="content" rows="12" style="border-radius: 0 0 8px 8px;" placeholder="Tulis isi lengkap artikel di sini. Gunakan tombol '+ Upload & Sisipkan Gambar' di atas untuk menyisipkan foto di antara paragraf." required>{{ old('content') }}</textarea>
